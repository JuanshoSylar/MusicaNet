<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrCancionAdmin.aspx.cs" Inherits="FrCancionAdmin" %>
                    ...
                    <table class="style1">
                        ...
                        <tr>
                            ...
                            <td class="style4">
                                &nbsp;</td>
                            <td>
                                <asp:GridView ID="grCancion" runat="server" AutoGenerateColumns="False">
                                    <Columns>
                        ...
                        <tr>
                            <td class="style5">
                                <asp:Label ID="lbDisco" runat="server" Text="Disco: "></asp:Label>
                            </td>
                            <td class="style6">
                                <asp:DropDownList ID="cbDisco" runat="server" Width="129px">
                                </asp:DropDownList>
                            </td>
                            <td class="style4">
                                &nbsp;</td>
